...
// необходимо это отменить, то можно воспользоваться методом db.SetAutoSync()
...
// GetJSON преобразует значение из хранилища обратно объект. Возвращает ошибку,
// если данные с таким ключем не сохранены или формат сохраненных данных не
// соответствует формату JSON.
